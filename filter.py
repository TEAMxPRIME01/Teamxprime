...
bot = telebot.TeleBot('7622187634:AAFKu3lmdzs9d0H8YJOTZh2GjX6IF5j2pCs')
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 TEAMxPRIME 𝗯𝗼𝘁!", reply_markup=markup)
...
def handle_buy_callback(call):
    admin_username = "@Vansh_Rathor"  # Replace with your admin username
    coin_plans = {
        "buy_50": "50 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 75 Rs",
        "buy_100": "100 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 150 Rs",
        "buy_200": "200 coins \n💰 𝗣𝗿𝗶𝗰𝗲: 300 Rs"
